      ...
      <form className="space-y-4 flex-1" onSubmit={handleSubmit}>
        ...
        {[
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-2xl shadow-inner focus:ring-2 focus:ring-blue-400 focus:outline-none text-gray-700 placeholder-gray-400 bg-white"
          />
        ))}
        ...
        <select
          ...
          className="w-full px-4 py-3 rounded-2xl shadow-inner focus:ring-2 focus:ring-blue-400 focus:outline-none text-gray-700 bg-white"
        >
          <option value="">
