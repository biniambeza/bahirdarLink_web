...
import EditResponderTeamDrawer from "./EditResponderTeamPage";
...
// Table Row
const TeamRow = ({ team, onEditClick }) => {
    ...
    >
      ...
      <td className="px-6 py-4 text-right flex justify-end items-center gap-2">
        ...
        <button
          ...
          className="p-2 hover:bg-white hover:shadow-sm border border-transparent hover:border-slate-200 rounded-lg text-slate-400 hover:text-blue-600 transition-all"
        >
