        ...
        >
          ...
          <div className="bg-white px-6 py-5 flex justify-between items-center border-b border-slate-200 sticky top-0 z-10">
            <div className="flex items-center gap-4 min-w-0">
              <div
                className={`px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border shrink-0 ${status.bg} ${status.text} ${status.border}`}
              >
                {status.label}
              </div>
              ...
              <div className="flex items-center gap-5 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-slate-400 font-medium truncate">
                    {incident.guestId
                      ? "Guest User Account"
                      : renderEnglish(reporter?.email || reporter?.phone) ||
                        "Member"}
                  </p>
                </div>
              </div>
